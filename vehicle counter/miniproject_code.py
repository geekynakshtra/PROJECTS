...
#web camera
cap = cv2.VideoCapture('video of vehicles.mp4')

min_width_rect= 80
min_height_rect= 80

count_line_position= 550
#Initialize Subtactor
...
while True:
    ...
    for(i,c) in enumerate(counter_shape):
        ...
        cv2.putText(frame1, "VEHCLE COUNTER :"+str(counter), (x,y-20), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,244,0), 2)          
    ...
    cv2.putText(frame1, "VEHCLE COUNTER :"+str(counter), (450,70), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,0,255), 5)
